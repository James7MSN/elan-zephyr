...
/* 0~10 */  
	PORTA_Int_IRQn								= 0, 	//GPIOA
	PORTB_Int_IRQn								= 1, 	//GPIOB
  DMA_IRQn          						= 2, 	//DMA wrapper - 967 is invalid
	WakeUp_Int_IRQn								= 3, 	//Wakeup
	USB_Setup_IRQn                = 4,  //USB Setup
	USB_Suspend_IRQn              = 5,  //USB Suspend
	USB_Resume_IRQn               = 6,  //USB Resume
	USB_Reset_IRQn                = 7,  //USB Reset
  USB_EPx_In_EPx_Empty_IRQn     = 8, 	//USB EPx_In/EPx_Empty
  USB_EPx_Out_IRQn              = 9, //USB EPx_Out
  USB_SOF_IRQn                  = 10, //USB SOF
/* 11~20 */	
  USB_Error_SE1_IRQn            = 11, //USB Error/SE1
  USB_LPM_RESUME_EXTPCKG_IRQn   = 12, //USB LPM RESUME EXTPCKG	
	TIMER1_IRQn                   = 13, //TIMER1 	
  TIMER2_IRQn                   = 14, //TIMER2 	
	SSP_IRQn											= 15, //ARM SSP
  UART1TX_Int_IRQn              = 16, //UART1 RX 
  UART1RX_Int_IRQn              = 17, //UART1 TX 		
  UARTOVF1_IRQn              		= 18, //UART1 overflow	
  UART2TX_Int_IRQn              = 19, //UART2 RX
  UART2RX_Int_IRQn              = 20, //UART2 TX
/* 21~30 */    
  UARTOVF2_IRQn              		= 21, //UART2 overflow	
	I2C1_TX_IRQn									= 22, //I2C1 TX
	I2C1_RX_IRQn									= 23, //I2C1 RX
  I2C1_SM_IRQn              		= 24, //I2C1 SM TOIF
  RTC_Int_IRQn                  = 25, //RTC int      
  RTCAlarm_IRQn                 = 26, //RTC alarm int
  PWMA_Int_IRQn              		= 27, //PWMA
	PWMB_Int_IRQn             		= 28, //PWMB     
  PWMC_Int_IRQn              		= 29, //PWMC     
	TIMER3_IRQn                   = 30, //TIMER3 
/* 31~40 */   
  TIMER4_IRQn                   = 31, //TIMER4 	
  SPI_IRQn                   		= 32, //Elan SPI 	
  I2C2_TX_IRQn									= 33, //I2C2 TX
	I2C2_RX_IRQn									= 34, //I2C2 RX 
  I2C2_SM_IRQn									= 35, //I2C2 SM TOIF 
  DMY_ISO78161_FINISH_IRQn			= 36, //7816-1 Finish
  DMY_ISO78161_ERROR_IRQn				= 37, //7816-1 ERROR
  DMY_ISO78162_FINISH_IRQn			= 38, //7816-2 Finish
  DMY_ISO78162_ERROR_IRQn				= 39, //7816-2 ERROR
  ECC_IRQn                			= 40, //ECC   
/* 41~50 */     
  TRNG_IRQn                			= 41, //TRNG 
  ENCRYPT_IRQn             			= 42, //ENCRYPT   
  DMY_LVD_USB_IRQn             	= 43, //LVD USB   
  DMY_LVD_DCDC_IRQn            	= 44, //LVD DCDC   
  DMY_LVD_FLASH_IRQn           	= 45, //LVD FLASH   
  SYSTEMHOLD_IRQn               = 46, //Systemhold  
  EXTERNAL_SPI_IRQn             = 47, //External SPI    
  DMY_GHM_ACC1_IRQn             = 48, //GHM ACC1
	GHM_PCA_IRQn                  = 49, //GHM HIST   
  GHM_MATCH_IRQn                = 50, //GHM MATCH     	
/* 51~60 */ 
  USRAT_TX_IRQn                 = 51, //USART TX 
  USRAT_RX_IRQn                 = 52, //USART RX 
  USRAT_ERR_IRQn                = 53, //USART ERR 
	DMA_IntTfr_IRQn								= 54, //DMA Transfer
	DMA_Intblock_IRQn							= 55, //DMA Block
	DMA_IntSrcTfr_IRQn						= 56, //DMA Source
	DMA_IntDstTfr_IRQn						= 57, //DMA Destination
	DMA_IntErr_IRQn								= 58, //DMA ERROR  
  LVD_VDD33_IRQn              	= 59, //LVD VDD33
  DMY_LVD_ADC_IRQn              = 60, //LVD ADC
/* 61~70 */  
  DMY_ISO7816_1_URERR_IRQn      = 61, //DMY_ISO7816_1_URERR
  DMY_ISO7816_1_RPTERR_IRQn     = 62, //DMY_ISO7816_1_RPTERR 
  DMY_ISO7816_1_ATR_IRQn        = 63, //DMY_ISO7816_1_ATR 
	DMY_ISO7816_1_RST_IRQn				= 64, //DMY_ISO7816_1_RST
	DMY_ISO7816_1_WT_IRQn					= 65, //DMY_ISO7816_1_WT
	DMY_ISO7816_2_URERR_IRQn			= 66, //DMY_ISO7816_2_URERR
	DMY_ISO7816_2_RPTERR_IRQn			= 67, //DMY_ISO7816_2_RPTERR
	DMY_ISO7816_2_ATR_IRQn				= 68, //DMY_ISO7816_2_ATR  
  DMY_ISO7816_2_RST_IRQn        = 69, //DMY_ISO7816_2_RST 
  DMY_ISO7816_2_WT_IRQn         = 70, //DMY_ISO7816_2_WT
/* 71~80 */ 
  HWDMACS_IRQn                  = 71, //DMA_HWCS
  DMY_GHM_IP_IRQn               = 72, //DMY_GHM_IP
  GHM_RANSAC_IRQn               = 73, //GHM_RANSAC
	SWSPI_BUF_FULL_IRQn						= 74, //SWSPI_BUF_FULL
	SWSPI_BUF_EMPTY_IRQn					= 75, //SWSPI_BUF_EMPTY
	SWSPI_FINISH_IRQn						  = 76, //SWSPI_FINISH
	Systemhold_EFT_IRQn						= 77, //Systemhold_EFT
	PWMD_Int_IRQn              		= 78, //PWMD
	PWME_Int_IRQn             		= 79, //PWME     
  PWMF_Int_IRQn              		= 80, //PWMF  
  SPIDMAFail_Int_IRQn          	= 81, // SPIDMAFail
  DMY_78161_ICSC_IRQn           = 82,
	DMY_78162_ICSC_IRQn	          = 83,
	I2C1_Wakeup_IRQn              = 84,
	I2C2_Wakeup_IRQn              = 85,
	UDC_Wakeup_IRQn               = 86,
	SPI_Wakeup_IRQn               = 87,
	GHM_DOUBLE_CHECK_IRQn         = 88,
	GHM_DISTINGUISH_RS_IRQn       = 89,
	GHM_DISTINGUISH_DC_IRQn       = 90,
  /*91~98*/
	GHM_MATCH_RATIO_IRQn          = 91,
	GHM_LSE_IRQn                  = 92,
	GHM_SAD_IRQn                  = 93,
	GHM_M2D_IRQn                  = 94,
	UARTTX3_IRQn                  = 95,    
...
#define CMSDK_APB1_BASE         (0x40000000UL)
#define CMSDK_APB2_BASE         (0x40010000UL)
#define CMSDK_AHB_BASE          (0x40020000UL)
#define CMSDK_APB3_BASE         (0x40030000UL)
#define CMSDK_GHM_BASE          (0x40040000UL)

/* APB1 peripherals */
#define CMSDK_TIMER1_BASE       (CMSDK_APB1_BASE + 0x0000UL)
#define CMSDK_TIMER2_BASE       (CMSDK_APB1_BASE + 0x1000UL)
#define CMSDK_UART1_BASE        (CMSDK_APB1_BASE + 0x2000UL)
#define CMSDK_I2C1_BASE         (CMSDK_APB1_BASE + 0x4000UL)
#define CMSDK_USB_BASE          (CMSDK_APB1_BASE + 0x5000UL)
#define CMSDK_PWM_BASE          (CMSDK_APB1_BASE + 0x6000UL)
#define CMSDK_UART3_BASE        (CMSDK_APB1_BASE + 0x7000UL)
#define CMSDK_SPI_BASE          (CMSDK_APB1_BASE + 0x9000UL)
#define CMSDK_78161_BASE        (CMSDK_APB1_BASE + 0xA000UL)

/* APB2 peripherals */
#define CMSDK_TIMER3_BASE       (CMSDK_APB2_BASE + 0x0000UL)
#define CMSDK_TIMER4_BASE       (CMSDK_APB2_BASE + 0x1000UL)
#define CMSDK_UART2_BASE        (CMSDK_APB2_BASE + 0x2000UL)
#define CMSDK_SSP_BASE          (CMSDK_APB2_BASE + 0x3000UL)
#define CMSDK_I2C2_BASE         (CMSDK_APB2_BASE + 0x4000UL)
#define CMSDK_ENCRYPT_BASE      (CMSDK_APB2_BASE + 0x6000UL)
#define CMSDK_ECC_BASE          (CMSDK_APB2_BASE + 0x7000UL)
#define CMSDK_TRNG_BASE         (CMSDK_APB2_BASE + 0x8000UL)
#define CMSDK_USART_BASE        (CMSDK_APB2_BASE + 0x9000UL)
#define CMSDK_78162_BASE        (CMSDK_APB2_BASE + 0xA000UL)

/* AHB peripherals */
#define CMSDK_GPIOA_BASE        (CMSDK_AHB_BASE + 0x0000UL)
#define CMSDK_GPIOB_BASE        (CMSDK_AHB_BASE + 0x1000UL)
#define CMSDK_DMA_BASE          (CMSDK_AHB_BASE + 0x2000UL)
#define CMSDK_SYSCTRL_BASE      (CMSDK_AHB_BASE + 0x3000UL)
#define CMSDK_EXTERNAL_SPI_BASE (CMSDK_AHB_BASE + 0x4000UL)

/* APB3 peripherals */
#define CMSDK_SYSCFG_BASE       (CMSDK_APB3_BASE + 0x0000UL)
#define CMSDK_PWR_BASE          (CMSDK_APB3_BASE + 0x1000UL)
#define CMSDK_RTC_BASE          (CMSDK_APB3_BASE + 0x2000UL)
#define CMSDK_BKP_BASE          (CMSDK_APB3_BASE + 0x3000UL)
#define CMSDK_FLASHCTL_BASE     (CMSDK_APB3_BASE + 0x4000UL)
#define CMSDK_WATCHDOG_BASE     (CMSDK_APB3_BASE + 0x5000UL)
#define CMSDK_AIP_BASE          (CMSDK_APB3_BASE + 0x6000UL)
#define CMSDK_CACHE_BASE        (CMSDK_APB3_BASE + 0x7000UL)
...
#define CMSDK_TIMER4            ((CMSDK_TIMER_TypeDef     *) CMSDK_TIMER4_BASE )
#define CMSDK_WATCHDOG          ((CMSDK_WATCHDOG_TypeDef  *) CMSDK_WATCHDOG_BASE )
#define CMSDK_GPIOA             ((CMSDK_GPIO_TypeDef   		*) CMSDK_GPIOA_BASE )
#define CMSDK_GPIOB             ((CMSDK_GPIO_TypeDef   		*) CMSDK_GPIOB_BASE )
