...
#define FLASHINFO_BASE				((uint32_t)0x100A0000) /*!< Info area(32 KB) base address in the alias region                        */
...
#define SPI_BASE              (APB1PERIPH_BASE + 0x8000)
#define ISO78161_BASE         (APB1PERIPH_BASE + 0x9000)
...
#define USART_BASE            (APB1PERIPH_BASE + 0x9000)
#define ISO78162_BASE         (APB1PERIPH_BASE + 0xA000)
...
#define AIP_BASE              (AHB1PERIPH_BASE + 0x6000)
#define CACHE_BASE            (AHB1PERIPH_BASE + 0x7000)
...
#define TEST_BASE             (AHB1PERIPH_BASE + 0x3000)
#define SYSCTRL_BASE          (AHB1PERIPH_BASE + 0x4000)
