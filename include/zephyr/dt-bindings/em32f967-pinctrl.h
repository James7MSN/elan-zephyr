...
/**
 * @brief EM32F967 Pin Control Definitions
 *
...
/* Pin configuration flags that match your device tree properties */
#define EM32_PINCTRL_BIAS_PULL_UP        BIT(0)
#define EM32_PINCTRL_BIAS_PULL_DOWN      BIT(1)
#define EM32_PINCTRL_DRIVE_STRENGTH_HIGH BIT(2)
#define EM32_PINCTRL_DRIVE_OPEN_DRAIN    BIT(3)

/* Macros to extract pin information */
#define EM32F967_GET_PORT(pinmux) (((pinmux) >> 8) & 0xFF)
#define EM32F967_GET_PIN(pinmux)  (((pinmux) >> 4) & 0xF)
#define EM32F967_GET_FUNC(pinmux) ((pinmux) & 0xF)
